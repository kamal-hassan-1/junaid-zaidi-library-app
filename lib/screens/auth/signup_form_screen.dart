...
/// to auto-select the Department dropdown as the student types their
...
/// simply leave Department untouched for manual selection rather than
/// blocking the form.
...
class _SignupFormScreenState extends State<SignupFormScreen> {
  ...
  // Tracks whether the student has manually picked a Department from
  // the dropdown themselves â€” once true, auto-fill from the
  // registration number stops overwriting their choice.
